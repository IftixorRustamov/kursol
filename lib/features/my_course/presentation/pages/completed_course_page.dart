...
class CompletedCoursePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      length: 2,
      child: Scaffold(
        backgroundColor: isDarkMode ? AppColors.background.dark : Colors.white, // ✅ Dark Mode foni
        appBar: AppBar(
          title: Text(
            courseDetail.title,
            style: UrbanistTextStyles().bold(
              color: isDarkMode ? Colors.white : AppColors.black, // ✅ Dark Mode uchun matn oq bo'ladi
              fontSize: 22,
            ),
          ),
          backgroundColor: isDarkMode ? AppColors.background.dark2 : Colors.white, // ✅ AppBar foni
          elevation: 0,
          leading: IconButton(
          ...
          bottom: TabBar(
            ...
            unselectedLabelColor: isDarkMode ? AppColors.greyScale.grey400 : Colors.grey, // ✅ Dark Mode uchun moslashuv
            ...
            children: [
              ...
              SingleChildScrollView(
                child: LessonListWidget(
                  ...
                  isDarkMode: isDarkMode, // ✅ Dark Mode bilan moslashdi
                ),
              ),
